...
class Product(models.Model):
  ...
  t_description = models.CharField(max_length=255,verbose_name="Descripción del producto", null=True)
  n_ranking = models.IntegerField(null=True, blank=True, default=5, validators=[MaxValueValidator(5),MinValueValidator(1)])
  t_type = models.CharField(choices=PRODUCT_TYPE, verbose_name="Tipo de producto", max_length=255)
  n_price = models.IntegerField(null=True, blank=True)
  fk_client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name="ProductoGeneral")
